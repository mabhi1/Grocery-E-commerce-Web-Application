...
function Checkout() {
  ...
  const handleCheckout = () => {
    ...
    fetch("https://asian-mart-express.onrender.com/create-checkout-session", {
      method: "POST",
      headers: {
            ...
            <div className="w-75" style={{ maxWidth: "600px" }}>
              <Form style={{ textAlign: "left" }}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control type="text" className="form-control" id="name" defaultValue={data?.getUser.name} disabled readOnly />
                </Form.Group>

                <Form.Group className="mb-3">
                  <Form.Label htmlFor="email">Email</Form.Label>
                  <Form.Control type="text" className="form-control" id="email" defaultValue={data?.getUser.email} disabled readOnly />
                </Form.Group>
